...
//
//import sephiroth.android.library.imagezoom.IDisposable;
//import sephiroth.android.library.imagezoom.RotateBitmap;
//import sephiroth.android.library.imagezoom.easing.Cubic;
...
//
//public class mImageViewTouchBase extends ImageView implements IDisposable {
//
...
//	};
//
//	//private static final String TAG = mImageViewTouchBase.class.getSimpleName();
//
...
//
//	public mImageViewTouchBase( Context context )
//	{
//		super( context );
//		init();
//	}
//
//	public mImageViewTouchBase( Context context, AttributeSet attrs )
//	{
//		super( context, attrs );
//		init();
//	}
...
//		matrix.reset();
//		float widthScale = Math.min( viewWidth / w, MAX_ZOOM ); //TODO
//		float heightScale = Math.min( viewHeight / h, MAX_ZOOM ); //TODO
